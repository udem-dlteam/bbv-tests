...
(define-macro (MAPop* kind op . args)
  (if (<= (length args) 2)
    `(MAPop ,kind ,op ,@args)
    `(MAPop* ,kind ,op (MAPop2 ,kind ,op ,(car args) ,(cadr args)) ,@(cddr args))))
...
(define-macro-arithmetic (GEN+ x . rest)               `(MAPop* GEN + ,x ,@rest))
(define-macro-arithmetic (GEN- x . rest)               `(MAPop* GEN - ,x ,@rest))
(define-macro-arithmetic (GEN* x . rest)               `(MAPop* GEN * ,x ,@rest))
(define-macro-arithmetic (GEN/ x . rest)               `(MAPop* GEN / ,x ,@rest))
...
(define-macro-arithmetic (SFL+ x . rest)               `(MAPop* SFL + ,x ,@rest))
(define-macro-arithmetic (SFL- x . rest)               `(MAPop* SFL - ,x ,@rest))
(define-macro-arithmetic (SFL* x . rest)               `(MAPop* SFL * ,x ,@rest))
(define-macro-arithmetic (SFL/ x . rest)               `(MAPop* SFL / ,x ,@rest))
...
(define-macro-arithmetic (SFX+ x . rest)    `(MAPop* SFX + ,x ,@rest))
(define-macro-arithmetic (SFX- x . rest)    `(MAPop* SFX - ,x ,@rest))
(define-macro-arithmetic (SFX* x . rest)    `(MAPop* SFX * ,x ,@rest))
