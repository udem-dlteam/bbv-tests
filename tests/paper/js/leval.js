/*=====================================================================*/
/*    serrano/prgm/project/bbv-tests/tests/paper/js/leval.js           */
/*    -------------------------------------------------------------    */
...
function run(o) {
   ...
   while( n-- > 0 ) {
      ...
      ewal(tak);
      ewal(fib);
      res = [ ewal(takcall), ewal(fibcall), ewal(cntref) ]
   }
...
function check(result) {
   if (!(result[0] === 4 && result[1] === 10946 && result[2] === 1452256)) {
