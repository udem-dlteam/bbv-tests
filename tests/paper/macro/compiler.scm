...
(define character-encoding (lambda (c) (Schar->integer c)))
(define max-character-encoding 255)
(define (fatal-err msg arg) (cond-expand (bigloo (error 'compiler msg arg)) (else (fatal-error msg arg))))
...
(define (gnode-label x) (Svector-ref x 0))
(define (gnode-edges x) (Svector-ref x 1))
...
(define (queue->list queue) (Scar queue))
(define (queue-empty) (cons '() '()))
(define (queue-empty? queue) (null? (Scar queue)))
...
(define (close-sf sf) (close-input-port (Svector-ref sf 0)))
(define (sf-read-char sf)
  (let ((c (read-char (Svector-ref sf 0))))
    ...
    c))
(define (sf-peek-char sf) (peek-char (Svector-ref sf 0)))
...
(define (source-code x) (Svector-ref x 0))
(define (source-code-set! x y) (Svector-set! x 0 y) x)
(define (source-locat x) (Svector-ref x 1))
...
(define (var-name x) (Svector-ref x 1))
(define (var-bound x) (Svector-ref x 2))
(define (var-refs x) (Svector-ref x 3))
(define (var-sets x) (Svector-ref x 4))
(define (var-source x) (Svector-ref x 5))
(define (var-info x) (Svector-ref x 6))
(define (var-name-set! x y) (Svector-set! x 1 y))
(define (var-bound-set! x y) (Svector-set! x 2 y))
(define (var-refs-set! x y) (Svector-set! x 3 y))
(define (var-sets-set! x y) (Svector-set! x 4 y))
(define (var-source-set! x y) (Svector-set! x 5 y))
(define (var-info-set! x y) (Svector-set! x 6 y))
...
(define (env-declare env decl)
  (vector (Svector-ref env 0)
          ...
          (env-parent-ref env)))
(define (env-vars-ref env) (Scar (Svector-ref env 0)))
(define (env-vars-set! env vars) (Sset-car! (Svector-ref env 0) vars))
(define (env-macros-ref env) (Svector-ref env 1))
(define (env-decls-ref env) (Svector-ref env 2))
(define (env-parent-ref env) (Svector-ref env 3))
...
(define (node-parent x) (Svector-ref x 1))
(define (node-children x) (Svector-ref x 2))
(define (node-fv x) (Svector-ref x 3))
(define (node-decl x) (Svector-ref x 4))
(define (node-source x) (Svector-ref x 5))
(define (node-parent-set! x y) (Svector-set! x 1 y))
(define (node-fv-set! x y) (Svector-set! x 3 y))
(define (node-decl-set! x y) (Svector-set! x 4 y))
(define (node-source-set! x y) (Svector-set! x 5 y))
...
(define (cst-val x) (Svector-ref x 6))
(define (cst-val-set! x y) (Svector-set! x 6 y))
...
(define (ref-var x) (Svector-ref x 6))
(define (ref-var-set! x y) (Svector-set! x 6 y))
...
(define (set-var x) (Svector-ref x 6))
(define (set-var-set! x y) (Svector-set! x 6 y))
...
(define (def-var x) (Svector-ref x 6))
(define (def-var-set! x y) (Svector-set! x 6 y))
...
(define (prc-name x) (Svector-ref x 6))
(define (prc-min x) (Svector-ref x 7))
(define (prc-rest x) (Svector-ref x 8))
(define (prc-parms x) (Svector-ref x 9))
(define (prc-name-set! x y) (Svector-set! x 6 y))
(define (prc-min-set! x y) (Svector-set! x 7 y))
(define (prc-rest-set! x y) (Svector-set! x 8 y))
(define (prc-parms-set! x y) (Svector-set! x 9 y))
...
(define (c-intf-decls c-intf) (Svector-ref c-intf 0))
(define (c-intf-decls-set! c-intf x) (Svector-set! c-intf 0 x))
(define (c-intf-procs c-intf) (Svector-ref c-intf 1))
(define (c-intf-procs-set! c-intf x) (Svector-set! c-intf 1 x))
(define (c-intf-inits c-intf) (Svector-ref c-intf 2))
(define (c-intf-inits-set! c-intf x) (Svector-set! c-intf 2 x))
...
(define (include-filename source) (source-code (Scadr (source-code source))))
(define (begin-defs-body source) (Scdr (source-code source)))
(define (length? l n)
...
(define (reg? x) (SFX< x 10000))
(define (reg-num x) (SFXmodulo x 10000))
(define (make-stk num) (SFX+ num 10000))
(define (stk? x) (SFX= (SFXquotient x 10000) 1))
(define (stk-num x) (SFXmodulo x 10000))
(define (make-glo name) (SFX+ (enter-opnd name #t) 30000))
(define (glo? x) (SFX= (SFXquotient x 10000) 3))
(define (glo-name x) (Scar (Svector-ref *opnd-table* (SFXmodulo x 10000))))
(define (make-clo base index) (SFX+ (enter-opnd base index) 40000))
(define (clo? x) (SFX= (SFXquotient x 10000) 4))
(define (clo-base x) (Scar (Svector-ref *opnd-table* (SFXmodulo x 10000))))
(define (clo-index x) (Scdr (Svector-ref *opnd-table* (SFXmodulo x 10000))))
(define (make-lbl num) (SFX+ num 20000))
(define (lbl? x) (SFX= (SFXquotient x 10000) 2))
(define (lbl-num x) (SFXmodulo x 10000))
(define label-limit 9999)
(define (make-obj val) (SFX+ (enter-opnd val #f) 50000))
(define (obj? x) (SFX= (SFXquotient x 10000) 5))
(define (obj-val x) (Scar (Svector-ref *opnd-table* (SFXmodulo x 10000))))
(define (make-pcontext fs map) (vector fs map))
(define (pcontext-fs x) (Svector-ref x 0))
(define (pcontext-map x) (Svector-ref x 1))
(define (make-frame size slots regs closed live)
  (vector size slots regs closed live))
(define (frame-size x) (Svector-ref x 0))
(define (frame-slots x) (Svector-ref x 1))
(define (frame-regs x) (Svector-ref x 2))
(define (frame-closed x) (Svector-ref x 3))
(define (frame-live x) (Svector-ref x 4))
(define (frame-eq? x y) (SFX= (frame-size x) (frame-size y)))
...
(define (proc-obj-name obj) (Svector-ref obj 1))
(define (proc-obj-primitive? obj) (Svector-ref obj 2))
(define (proc-obj-code obj) (Svector-ref obj 3))
(define (proc-obj-call-pat obj) (Svector-ref obj 4))
(define (proc-obj-test obj) (Svector-ref obj 5))
(define (proc-obj-inlinable obj) (Svector-ref obj 6))
(define (proc-obj-specialize obj) (Svector-ref obj 7))
(define (proc-obj-side-effects? obj) (Svector-ref obj 8))
(define (proc-obj-strict-pat obj) (Svector-ref obj 9))
(define (proc-obj-type obj) (Svector-ref obj 10))
(define (proc-obj-code-set! obj x) (Svector-set! obj 3 x))
(define (proc-obj-test-set! obj x) (Svector-set! obj 5 x))
(define (proc-obj-inlinable-set! obj x) (Svector-set! obj 6 x))
(define (proc-obj-specialize-set! obj x) (Svector-set! obj 7 x))
...
(define (pattern-member? n pat)
  (cond ((pair? pat) (if (SFX= (Scar pat) n) #t (pattern-member? n (Scdr pat))))
        ((null? pat) #f)
        (else (SFX<= pat n))))
(define (type-name type) (if (pair? type) (Scar type) type))
...
(define (bbs-lbl-counter bbs) (Svector-ref bbs 0))
(define (bbs-lbl-counter-set! bbs cntr) (Svector-set! bbs 0 cntr))
(define (bbs-bb-queue bbs) (Svector-ref bbs 1))
(define (bbs-bb-queue-set! bbs bbq) (Svector-set! bbs 1 bbq))
(define (bbs-entry-lbl-num bbs) (Svector-ref bbs 2))
(define (bbs-entry-lbl-num-set! bbs lbl-num) (Svector-set! bbs 2 lbl-num))
...
(define (make-bb label-instr bbs)
  (let ((bb (vector label-instr (queue-empty) '() '() '())))
    ...
    bb))
(define (bb-lbl-num bb) (label-lbl-num (Svector-ref bb 0)))
(define (bb-label-type bb) (label-type (Svector-ref bb 0)))
(define (bb-label-instr bb) (Svector-ref bb 0))
(define (bb-label-instr-set! bb l) (Svector-set! bb 0 l))
(define (bb-non-branch-instrs bb) (queue->list (Svector-ref bb 1)))
(define (bb-non-branch-instrs-set! bb l) (Svector-set! bb 1 (list->queue l)))
(define (bb-branch-instr bb) (Svector-ref bb 2))
(define (bb-branch-instr-set! bb b) (Svector-set! bb 2 b))
(define (bb-references bb) (Svector-ref bb 3))
(define (bb-references-set! bb l) (Svector-set! bb 3 l))
(define (bb-precedents bb) (Svector-ref bb 4))
(define (bb-precedents-set! bb l) (Svector-set! bb 4 l))
...
(define (gvm-instr-type gvm-instr) (Svector-ref gvm-instr 0))
(define (gvm-instr-frame gvm-instr) (Svector-ref gvm-instr 1))
(define (gvm-instr-comment gvm-instr) (Svector-ref gvm-instr 2))
...
(define (label-lbl-num gvm-instr) (Svector-ref gvm-instr 3))
(define (label-lbl-num-set! gvm-instr n) (Svector-set! gvm-instr 3 n))
(define (label-type gvm-instr) (Svector-ref gvm-instr 4))
(define (label-entry-nb-parms gvm-instr) (Svector-ref gvm-instr 5))
(define (label-entry-min gvm-instr) (Svector-ref gvm-instr 6))
(define (label-entry-rest? gvm-instr) (Svector-ref gvm-instr 7))
(define (label-entry-closed? gvm-instr) (Svector-ref gvm-instr 8))
(define (make-apply prim opnds loc frame comment)
  (vector 'apply frame comment prim opnds loc))
(define (apply-prim gvm-instr) (Svector-ref gvm-instr 3))
(define (apply-opnds gvm-instr) (Svector-ref gvm-instr 4))
(define (apply-loc gvm-instr) (Svector-ref gvm-instr 5))
(define (make-copy opnd loc frame comment)
  (vector 'copy frame comment opnd loc))
(define (copy-opnd gvm-instr) (Svector-ref gvm-instr 3))
(define (copy-loc gvm-instr) (Svector-ref gvm-instr 4))
(define (make-close parms frame comment) (vector 'close frame comment parms))
(define (close-parms gvm-instr) (Svector-ref gvm-instr 3))
(define (make-closure-parms loc lbl opnds) (vector loc lbl opnds))
(define (closure-parms-loc x) (Svector-ref x 0))
(define (closure-parms-lbl x) (Svector-ref x 1))
(define (closure-parms-opnds x) (Svector-ref x 2))
(define (make-ifjump test opnds true false poll? frame comment)
  (vector 'ifjump frame comment test opnds true false poll?))
(define (ifjump-test gvm-instr) (Svector-ref gvm-instr 3))
(define (ifjump-opnds gvm-instr) (Svector-ref gvm-instr 4))
(define (ifjump-true gvm-instr) (Svector-ref gvm-instr 5))
(define (ifjump-false gvm-instr) (Svector-ref gvm-instr 6))
(define (ifjump-poll? gvm-instr) (Svector-ref gvm-instr 7))
(define (make-jump opnd nb-args poll? frame comment)
  (vector 'jump frame comment opnd nb-args poll?))
(define (jump-opnd gvm-instr) (Svector-ref gvm-instr 3))
(define (jump-nb-args gvm-instr) (Svector-ref gvm-instr 4))
(define (jump-poll? gvm-instr) (Svector-ref gvm-instr 5))
...
(define (code-bb code) (Svector-ref code 0))
(define (code-gvm-instr code) (Svector-ref code 1))
(define (code-slots-needed code) (Svector-ref code 2))
(define (code-slots-needed-set! code n) (Svector-set! code 2 n))
...
(define (target-name x) (Svector-ref x 1))
(define (target-begin! x) (Svector-ref x 2))
(define (target-begin!-set! x y) (Svector-set! x 2 y))
(define (target-end! x) (Svector-ref x 3))
(define (target-end!-set! x y) (Svector-set! x 3 y))
(define (target-dump x) (Svector-ref x 4))
(define (target-dump-set! x y) (Svector-set! x 4 y))
(define (target-nb-regs x) (Svector-ref x 5))
(define (target-nb-regs-set! x y) (Svector-set! x 5 y))
(define (target-prim-info x) (Svector-ref x 6))
(define (target-prim-info-set! x y) (Svector-set! x 6 y))
(define (target-label-info x) (Svector-ref x 7))
(define (target-label-info-set! x y) (Svector-set! x 7 y))
(define (target-jump-info x) (Svector-ref x 8))
(define (target-jump-info-set! x y) (Svector-set! x 8 y))
(define (target-proc-result x) (Svector-ref x 9))
(define (target-proc-result-set! x y) (Svector-set! x 9 y))
(define (target-task-return x) (Svector-ref x 10))
...
(define (context-slots x) (Svector-ref x 1))
(define (context-regs x) (Svector-ref x 2))
(define (context-closed x) (Svector-ref x 3))
(define (context-poll x) (Svector-ref x 4))
(define (context-entry-bb x) (Svector-ref x 5))
(define (context-entry-bb-set! x y) (Svector-set! x 5 y))
(define nb-slots '())
(define slots '())
(define regs '())
(define closed '())
...
(define (poll-since-entry? x) (Scar x))
(define (poll-delta x) (Scdr x))
(define (entry-poll) (make-poll #f (SFX- poll-period poll-head)))
...
(define (seal-bb poll? where)
  (define (my-last-pair l) (if (pair? (Scdr l)) (my-last-pair (Scdr l)) l))
...
(define (jump-state-in-reg x) (Svector-ref x 1))
...
(define (free-vars-order l)
  (let ((bins '()) (ordered-args '()))
    ...
    (for-each
     (lambda (x) (for-each add-to-bin! (set->list (free-v (Scar x)))))
     l)
...
(define (ofile-string s)
  (let ((len (Sstring-length s)))
    (define (ref i) (if (SFX>= i len) 0 (character-encoding (Sstring-ref s i))))
    (let loop ((i 0))
      (if (SFX< i len)
          (begin
...
(define (make-encoding data type) (SFX+ (SFX* data 8) type))
(define (obj-type obj)
...
(define (asm-word x) (queue-put! asm-code-queue (SFXmodulo x 65536)))
...
(define (asm-assemble! debug-info)
  ...
  (define stat-len 4)
  (define (padding loc n offset) (SFXmodulo (SFX- offset loc) n))
...
(define (dreg? x) (and (integer? x) (SFX>= x 0) (SFX< x 8)))
(define (dreg-num x) x)
(define (make-areg num) (SFX+ num 8))
(define (areg? x) (and (integer? x) (SFX>= x 8) (SFX< x 16)))
(define (areg-num x) (SFX- x 8))
(define (make-ind areg) (SFX+ areg 8))
(define (ind? x) (and (integer? x) (SFX>= x 16) (SFX< x 24)))
(define (ind-areg x) (SFX- x 8))
(define (make-pinc areg) (SFX+ areg 16))
(define (pinc? x) (and (integer? x) (SFX>= x 24) (SFX< x 32)))
(define (pinc-areg x) (SFX- x 16))
(define (make-pdec areg) (SFX+ areg 24))
(define (pdec? x) (and (integer? x) (SFX>= x 32) (SFX< x 40)))
(define (pdec-areg x) (SFX- x 24))
(define (make-disp areg offset) (SFX+ (SFX+ areg 32) (SFX* (SFXmodulo offset 65536) 8)))
(define (disp? x) (and (integer? x) (SFX>= x 40) (SFX< x 524328)))
(define (disp-areg x) (SFX+ (SFXremainder x 8) 8))
...
(define (inx? x) (and (integer? x) (SFX>= x 524328) (SFX< x 557096)))
(define (inx-areg x) (SFX+ (SFXremainder (SFX- x 524328) 8) 8))
(define (inx-ireg x) (SFXquotient (SFXremainder (SFX- x 524328) 128) 8))
(define (inx-offset x)
  (SFX- (SFXmodulo (SFX+ (SFXquotient (SFX- x 524328) 128) 128) 256) 128))
(define (make-freg num) (SFX+ 557096 num))
(define (freg? x) (and (integer? x) (SFX>= x 557096) (SFX< x 557104)))
(define (freg-num x) (SFX- x 557096))
(define (make-pcr lbl offset)
  (SFX+ 557104 (SFX+ (SFXmodulo offset 65536) (SFX* lbl 65536))))
(define (pcr? x) (and (integer? x) (SFX>= x 557104)))
(define (pcr-lbl x) (SFXquotient (SFX- x 557104) 65536))
(define (pcr-offset x) (SFX- (SFXmodulo (SFX- x 524336) 65536) 32768))
(define (make-imm val) (if (SFX< val 0) (SFX* val 2) (SFX- -1 (SFX* val 2))))
(define (imm? x) (and (integer? x) (SFX< x 0)))
(define (imm-val x) (if (SFXeven? x) (SFXquotient x 2) (SFX- (SFXquotient x 2))))
...
(define (trap-offset n) (SFX+ 32768 (SFX* (SFX- n 32) 8)))
...
(define (closed-var-offset i) (SFX+ (SFX* i pointer-size) 2))
...
(define (stat-dump!) (emit-stat (Scdr *stats*)))
...
(define current-fs '())
(define (adjust-current-fs n) (set! current-fs (SFX+ current-fs n)))
(define (new-lbl!) (label-counter))
(define (needed? loc sn) (and loc (if (stk? loc) (SFX<= (stk-num loc) sn) #t)))
    ...
    (let loop ((i min))
      (if (SFX<= i nb-parms)
          (let ((val (if (SFX= i nb-parms*) bits-null bits-unass)))
            ...
            (loop (SFX+ i 1)))))))
(define (encode-arg-count n) (cond ((SFX= n 1) -1) ((SFX= n 2) 0) (else (SFX+ n 1))))
...
(define-apply
 "##MAKE-CELL"
 #f
 (lambda (opnds loc sn) (gen-cons (list (Scar opnds) (make-obj '())) loc sn)))
