(set-custom-version-limits! 2 10 4 1 3 1 6 2 7 10 3 9 3 8 4 6 4 5 1 3 5 6 6 2 7
  8 3 10 9 2 9 4 10 8 10 6 2 4 1 2 4 9 9 1 1 8 10 9 5 2 3 5 2 4 9 3 5 5 10 3 6 10
  5 8 4 5 3 7 10 5 1 1 6 10 5 4 7 3 7 3 8 10 2 8 9 1 2 10 3 10 7 3 1 5 6 1 6 10 4
  2 3 9 7 10 6 4 3 3 7 5 2 6 7 4 5 6 2 7 1 10 8 10 6 6 5 4 5 1 7 3 4 5 2 5 6 6 7 9
  6 4 2 5 7 6 10 10 2)
...
(define (Zcall-with-input-file path proc) (set-bbv-version-limit! #f) 
...
(define (Zcall-with-output-file/truncate path proc) (set-bbv-version-limit! #f) 
  (let* ((port (list '()))
         (result (proc port))
...
(define slatex.append!
  (lambda (l1 l2) (set-bbv-version-limit! #f) 
    (if (pair? l1)
        (let loop ((curr l1))
          (let ((next (Scdr curr)))
            (if (pair? next)
...
(define slatex.append-map!
  (lambda (f l) (set-bbv-version-limit! #f) 
    (let loop ((l l))
      (if (pair? l) (slatex.append! (f (Scar l)) (loop (Scdr l))) '()))))

(define slatex.remove-if!
  (lambda (p s) (set-bbv-version-limit! #f) 
    (let loop ((s s))
      (if (pair? s)
          (if (p (Scar s))
              (loop (Scdr s))
...
(define slatex.reverse!
  (lambda (s) (set-bbv-version-limit! #f) 
    (let loop ((s s) (r '()))
      (if (pair? s) (let ((d (Scdr s))) (Sset-cdr! s r) (loop d s)) r))))

;;(define slatex.list-set!
;;  (lambda (l i v) (set-bbv-version-limit! #f) 
;;    (let loop ((l l) (i i))
...
(define slatex.list-prefix?
  (lambda (pfx l) (set-bbv-version-limit! #f) 
    (cond ((null? pfx) #t)
          ((null? l) #f)
...
(define slatex.string-prefix?
  (lambda (pfx s) (set-bbv-version-limit! #f) 
...
(define slatex.string-suffix?
  (lambda (sfx s) (set-bbv-version-limit! #f) 
...
(define slatex.member-string
  (lambda (key lst) (set-bbv-version-limit! #f) 
    (let loop ((lst lst))
      (if (pair? lst)
...
(define slatex.adjoin-string
  (lambda (s l) (set-bbv-version-limit! #f)  (if (slatex.member-string s l) l (cons s l))))

(define slatex.remove-string!
  (lambda (s l) (set-bbv-version-limit! #f)  (slatex.remove-if! (lambda (l_i) (set-bbv-version-limit! #f)  (Sstring=? l_i s)) l)))

(define slatex.adjoin-char (lambda (c l) (set-bbv-version-limit! #f)  (if (Smemv c l) l (cons c l))))

(define slatex.remove-char!
  (lambda (c l) (set-bbv-version-limit! #f)  (slatex.remove-if! (lambda (l_i) (set-bbv-version-limit! #f)  (Schar=? l_i c)) l)))

(define slatex.sublist
  (lambda (l i f) (set-bbv-version-limit! #f) 
...
(define slatex.position-char
  (lambda (c l) (set-bbv-version-limit! #f) 
    (let loop ((l l) (i 0))
      (cond ((null? l) #f)
            ((Schar=? (Scar l) c) i)
            (else (loop (Scdr l) (SFX+ i 1)))))))
...
(define slatex.string-position-right
  (lambda (c s) (set-bbv-version-limit! #f) 
...
(define slatex.token=?
  (lambda (t1 t2) (set-bbv-version-limit! #f) 
    (if slatex.*slatex-case-sensitive?* (Sstring=? t1 t2) (Sstring-ci=? t1 t2))))

(define slatex.assoc-token
  (lambda (x s) (set-bbv-version-limit! #f) 
    (slatex.ormap (lambda (s_i) (set-bbv-version-limit! #f)  (if (slatex.token=? (Scar s_i) x) s_i #f)) s)))

(define slatex.member-token
  (lambda (x s) (set-bbv-version-limit! #f) 
    (slatex.ormapcdr
      (lambda (s_i..) (set-bbv-version-limit! #f)  (if (slatex.token=? (Scar s_i..) x) s_i.. #f))
      s)))

(define slatex.remove-token!
  (lambda (x s) (set-bbv-version-limit! #f)  (slatex.remove-if! (lambda (s_i) (set-bbv-version-limit! #f)  (slatex.token=? s_i x)) s)))

(define slatex.file-exists? (lambda (f) (set-bbv-version-limit! #f)  #t))

(define slatex.delete-file (lambda (f) (set-bbv-version-limit! #f)  'assume-file-deleted))
...
(define slatex.error
  (lambda (error-type error-values) (set-bbv-version-limit! #f) 
    (display "Error: ")
    (display error-type)
    (display ": ")
    (newline)
    (for-each (lambda (x) (set-bbv-version-limit! #f)  (write x) (newline)) error-values)
    (fatal-error "")))

(define slatex.keyword-tokens
  (map (lambda (sym) (set-bbv-version-limit! #f)  (Ssymbol->string sym))
       '(=> %
            abort
            and
            begin
...
(define slatex.tex-analog
  (lambda (c) (set-bbv-version-limit! #f) 
...
(define slatex.set-special-symbol
  (lambda (x transl) (set-bbv-version-limit! #f) 
...
(define slatex.unset-special-symbol
  (lambda (x) (set-bbv-version-limit! #f) 
    (set! slatex.special-symbols
      (slatex.remove-if!
        (lambda (c) (set-bbv-version-limit! #f)  (slatex.token=? (Scar c) x))
        slatex.special-symbols))))

(define slatex.texify (lambda (s) (set-bbv-version-limit! #f)  (Slist->string (slatex.texify-aux s))))
  ...
  (let* ((arrow (Sstring->list "-$>$")) (arrow-lh (length arrow)))
    (lambda (s) (set-bbv-version-limit! #f) 
      (let* ((sl (Sstring->list s))
             (texified-sl
               (slatex.append-map!
                 (lambda (c) (set-bbv-version-limit! #f)  (Sstring->list (slatex.tex-analog c)))
                 sl)))
        (slatex.ormapcdr
          (lambda (d) (set-bbv-version-limit! #f) 
...
(define slatex.display-begin-sequence
  (lambda (out) (set-bbv-version-limit! #f) 
...
(define slatex.display-tex-char
  (lambda (c p) (set-bbv-version-limit! #f)  (Zdisplay (if (char? c) (slatex.tex-analog c) c) p)))

(define slatex.display-token
  (lambda (s typ p) (set-bbv-version-limit! #f) 
    (cond ((eq? typ 'syntax)
           (Zdisplay "\\sy{" p)
...
(define slatex.display-space
  (lambda (s p) (set-bbv-version-limit! #f) 
...
(define slatex.get-line
  (let ((curr-notab slatex.&void-notab))
    (lambda (line) (set-bbv-version-limit! #f) 
...
(define slatex.peephole-adjust
  (lambda (curr prev) (set-bbv-version-limit! #f) 
...
(define slatex.remove-some-tabs
  (lambda (line i) (set-bbv-version-limit! #f) 
    (if i
      (let loop ((i i))
...
(define scheme2tex
  (lambda (inport outport) (set-bbv-version-limit! #f) 
...
(define slatex.output-token
  (lambda (token) (set-bbv-version-limit! #f) 
    (if (null? slatex.*case-stack*)
      'skip
      (let ((top (Scar slatex.*case-stack*)))
...
(define slatex.path->list
  (lambda (p) (set-bbv-version-limit! #f) 
...
(define slatex.find-some-file
  (lambda (path . files) (set-bbv-version-limit! #f) 
    (let loop ((path path))
      (if (null? path)
        #f
        (let ((dir (Scar path)))
          (let loop2 ((files (if (or (Sstring=? dir "") (Sstring=? dir "."))
                               files
                               (map (lambda (file) (set-bbv-version-limit! #f) 
                                      (Sstring-append
                                        dir
  ...
  (lambda (filename ext) (set-bbv-version-limit! #f) 
    (let* ((filename-len (Sstring-length filename))
      ...
      (cond ((SFX> ext-len filename-len) filename)
            ((LIBequal? ext (substring filename len-diff filename-len))
...
(define slatex.full-scmfile-name
  (lambda (filename) (set-bbv-version-limit! #f) 
    (apply slatex.find-some-file
           slatex.*texinputs-list*
           filename
           (map (lambda (extn) (set-bbv-version-limit! #f)  (Sstring-append filename extn))
                '(".scm" ".ss" ".s")))))
...
(define slatex.eat-till-newline
  (lambda (in) (set-bbv-version-limit! #f) 
    (let loop ()
      (let ((c (Zread-char in)))
...
(define slatex.chop-off-whitespace
  (lambda (l) (set-bbv-version-limit! #f) 
    (slatex.ormapcdr (lambda (d) (set-bbv-version-limit! #f)  (if (Schar-whitespace? (Scar d)) #f d)) l)))
...
(define slatex.read-delimed-commaed-filenames
  (lambda (in lft-delim rt-delim) (set-bbv-version-limit! #f) 
    (slatex.eat-latex-whitespace in)
    (let ((c (Zread-char in)))
      (if (Zeof-object? c)
...
(define slatex.read-grouped-commaed-filenames
  (lambda (in) (set-bbv-version-limit! #f)  (slatex.read-delimed-commaed-filenames in #\{ #\})))
...
(define slatex.ignore2 (lambda (i ii) (set-bbv-version-limit! #f)  'void))

(define slatex.add-to-slatex-db
  (lambda (in categ) (set-bbv-version-limit! #f) 
...
(define slatex.add-to-slatex-db-special
  (lambda (in what) (set-bbv-version-limit! #f) 
...
(define slatex.process-slatex-alias
  (lambda (in what which) (set-bbv-version-limit! #f) 
...
(define slatex.decide-latex-or-tex
  (lambda (latex?) (set-bbv-version-limit! #f) 
    ...
    (let ((pltexchk.jnk "pltexchk.jnk"))
      ...
      (if (not slatex.*latex?*)
        (Zcall-with-output-file/truncate
          pltexchk.jnk
          (lambda (outp) (set-bbv-version-limit! #f)  (Zdisplay "junk" outp) (Znewline outp)))))))
...
;    (newline)
    ...
    (let ((file-hide-file "xZfilhid.tex"))
      ...
      (if (eq? *op-sys* 'dos)
        (Zcall-with-output-file/truncate
          file-hide-file
          (lambda (out) (set-bbv-version-limit! #f)  (Zdisplay "\\def\\filehider{x}" out) (Znewline out)))))
...
(define slatex.dump-intext
  (lambda (in out) (set-bbv-version-limit! #f) 
    (let* ((display (if out (lambda (obj port) (set-bbv-version-limit! #f)  (Zdisplay obj port)) slatex.ignore2))
...
;;  (lambda (in out ender) (set-bbv-version-limit! #f) 
          ...
          (let ((buf (cons c buf)))
            (if (Schar=? c (Sstring-ref ender i))
                (if (SFX= i (SFX- ender-lh 1))
                    'done
                    (loop (SFX+ i 1) buf))
                (begin (for-each (lambda (c) (set-bbv-version-limit! #f)  (Zdisplay c out)) (slatex.reverse! buf)) (loop 0 '())))))))))

(define slatex.debug? #f)

(define slatex.process-tex-file
  (lambda (raw-filename) (set-bbv-version-limit! #f) 
    (if slatex.debug?
...
(define slatex.trigger-scheme2tex
  (lambda (typ in env) (set-bbv-version-limit! #f) 
...
(define slatex.inline-protected
  (lambda (typ in out env) (set-bbv-version-limit! #f) 
    (cond ((eq? typ 'envregion)
           (Zdisplay "\\begin{" out)
           (Zdisplay env out)
           (Zdisplay "}" out)
          ...
          (else
           (let ((f (Scar slatex.*protected-files*)))
             ...
             (Zcall-with-input-file
               f
               (lambda (in) (set-bbv-version-limit! #f)  (slatex.inline-protected-files in out)))
...
(define (run1) (set-bbv-version-limit! #f) 
  ...
  (map (lambda (x) (set-bbv-version-limit! #f)  (cons (Scar x) (Sstring-length (Scdr x))))
       filesystem))

(define expected-result '(("z56.tex" . 66) ("z56.scm" . 12) ("z55.tex" . 66) ("z55.scm" . 12) ("z54.tex" . 65) ("z54.scm" . 11) ("z53.tex" . 65) ("z53.scm" . 11) ("z52.tex" . 65) ("z52.scm" . 11) ("z51.tex" . 61) ("z51.scm" . 7) ("z50.tex" . 65) ("z50.scm" . 11) ("z49.tex" . 65) ("z49.scm" . 11) ("z48.tex" . 72) ("z48.scm" . 18) ("z47.tex" . 82) ("z47.scm" . 28) ("z46.tex" . 82) ("z46.scm" . 28) ("z45.tex" . 72) ("z45.scm" . 18) ("z44.tex" . 65) ("z44.scm" . 11) ("z43.tex" . 65) ("z43.scm" . 11) ("z42.tex" . 60) ("z42.scm" . 6) ("z41.tex" . 80) ("z41.scm" . 10) ("z40.tex" . 80) ("z40.scm" . 10) ("z39.tex" . 101) ("z39.scm" . 25) ("z38.tex" . 95) ("z38.scm" . 21) ("z37.tex" . 65) ("z37.scm" . 11) ("z36.tex" . 131) ("z36.scm" . 47) ("z35.tex" . 111) ("z35.scm" . 32) ("z34.tex" . 72) ("z34.scm" . 18) ("z33.tex" . 94) ("z33.scm" . 20) ("z32.tex" . 290) ("z32.scm" . 148) ("z31.tex" . 236) ("z31.scm" . 104) ("z30.tex" . 233) ("z30.scm" . 104) ("z29.tex" . 67) ("z29.scm" . 13) ("z28.tex" . 67) ("z28.scm" . 13) ("z27.tex" . 62) ("z27.scm" . 8) ("z26.tex" . 66) ("z26.scm" . 12) ("z25.tex" . 67) ("z25.scm" . 13) ("z24.tex" . 63) ("z24.scm" . 9) ("z23.tex" . 62) ("z23.scm" . 8) ("z22.tex" . 129) ("zz1.tex" . 70) ("zz1.scm" . 11) ("zz0.tex" . 77) ("z21.tex" . 58) ("z21.scm" . 4) ("z20.tex" . 59) ("z20.scm" . 5) ("z19.tex" . 78) ("z19.scm" . 15) ("z18.tex" . 103) ("z18.scm" . 34) ("z17.tex" . 75) ("z17.scm" . 12) ("z16.tex" . 68) ("z16.scm" . 9) ("z15.tex" . 363) ("z15.scm" . 172) ("z14.tex" . 133) ("z14.scm" . 53) ("z13.tex" . 674) ("z13.scm" . 346) ("z12.tex" . 336) ("z12.scm" . 165) ("z11.tex" . 58) ("z11.scm" . 4) ("z10.tex" . 247) ("z10.scm" . 89) ("z9.tex" . 58) ("z9.scm" . 4) ("z8.tex" . 56) ("z8.scm" . 2) ("z7.tex" . 75) ("z7.scm" . 11) ("z6.tex" . 160) ("z6.scm" . 65) ("z5.tex" . 55) ("z5.scm" . 1) ("z4.tex" . 55) ("z4.scm" . 1) ("z3.tex" . 56) ("z3.scm" . 2) ("z2.tex" . 57) ("z2.scm" . 2) ("z1.tex" . 60) ("z1.scm" . 6) ("z0.tex" . 60) ("z0.scm" . 6) ("test.tex" . 53404) ("slatex.sty" . 16460)))
