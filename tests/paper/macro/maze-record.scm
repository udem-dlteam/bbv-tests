...
(Sdefine-record cell
  ...
  parent        ; For DFS spanning tree construction.
  mark)         ; For marking the solution path.

(define-macro (new-cell reachable id)
...
(define (gen-maze-array r c)
  (harr-tabulate r c (lambda (x y) (new-cell (base-set 1) (cons x y)))))
