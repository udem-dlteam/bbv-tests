  ...
  (cond ((truep x true-lst)
        ...
        ((eq? (Scar x)
         ...
         (cond ((truep (Scadr x)
               ...
               ((falsep (Scadr x)
                        false-lst)
                (tautologyp (Scadddr x)
                            true-lst false-lst))
               (else (and (tautologyp (Scaddr x)
                                      (cons (Scadr x)
                                            true-lst)
                                      false-lst)
                          (tautologyp (Scadddr x)
